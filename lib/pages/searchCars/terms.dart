...
class TermsAndConditionsScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            children: [
              // Windows-specific header with close button
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          height: 36.0,
          decoration: BoxDecoration(
            color: isCloseButton ? Color(0xFFFF5F57) : Colors.transparent,
          ...
          child: Icon(
            icon,
            size: 16.0,
            color: isCloseButton ? Colors.white : Colors.black54,
          ),
        ),
      ),
    );
  ...
  void _minimizeWindow() {
    // Windows-specific minimize functionality
    // You'll need to implement this using window_manager or similar package
    print('Minimize window for Windows');
  }

  void _closeWindow() {
    // Windows-specific close functionality
    // You'll need to implement this using window_manager or similar package
